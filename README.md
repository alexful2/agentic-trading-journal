...
Claude code (deep dives, company dossier files, etc). Nothing is a fully automated research loop, at least yet (I'm currently building off this project to create a fully autonomous trading agent).
